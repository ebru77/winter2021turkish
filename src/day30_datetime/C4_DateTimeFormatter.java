...
public class C4_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println(dtf.format(tarih));//2021/Apr/17
        System.out.println(dtf2.format(tarih));//21/04/17
        System.out.println(dtf3.format(tarih));//2021$4$17
        System.out.println(dtf4.format(tarih));//2021-April-17
    }
}
