...
public class C4_DataCastingDaralma {
	...
	public static void main(String[] args) {
		...
		//daha dar bir data tipine cevirirken eger data tipinin sinirindan buyukse saymaya
		//negatif en kucuk sayidan devam eder. istenen sayiya gelinceye kadar tekrar tekrar en kucuk negatif sayiya gider
